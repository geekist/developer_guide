...
* [百度JavaScript代码规范](https://github.com/ecomfe/spec/blob/master/javascript-style-guide.md)

* [阿里巴巴前端规约](http://w3ctim.com/post/1d821dd8)---（[配套工具](https://github.com/alibaba/f2e-spec)）

* [京东前端代码规范](https://guide.aotu.io/index.html)

* [网易前端代码规范](http://nec.netease.com/standard)

* [Vue代码规范](https://cn.vuejs.org/v2/style-guide/index.html)
