...
* [八、网络及操作](#八网络及操作)
  * [网络操作常用命令](#网络操作常用命令)
    * [ping \- 发送 ICMP ECHO\_REQUEST 软件包到网络主机](#ping---发送-icmp-echo_request-软件包到网络主机)
...
* [十、常用工具](#十常用工具)
  ...
  * [3、常用的软件包命令](#3常用的软件包命令)
    ...
    * [yum erase package\_name 卸载软件](#yum-erase-package_name-卸载软件)
    * [rpm \-i package\_file 通过软件包文件来安装软件](#rpm--i-package_file-通过软件包文件来安装软件)
